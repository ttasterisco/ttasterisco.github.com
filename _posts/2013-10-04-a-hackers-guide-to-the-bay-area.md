    ...
    <td style="vertical-align:top;">
      <ul>
        ...
        <ul>
          ...
          <li>100º Farenheit = 37.78º Celsius</li>
...
The name comes from its most famous city: San Francisco.
...
But startups, medium and large companies can be found virtually anywhere in the area. And the high price of rents has been pushing companies to spread outer and outer of the original Valley.
...
Companies try to stay close to these transportation arteries (specially the Caltrain).
...
Oakland is not known for being a tech city, but nevertheless it is home for Ask.com and Pandora, among other startups that are [moving into the area](https://news.ycombinator.com/item?id=6441376).

## Living
Living in the Bay Area is not for the faint of wallet. Certain parts of the Bay Area are toe-to-toe with Manhattan in terms of cost of living [\[1\]](http://www.businessinsider.com/most-expensive-urban-areas-in-america-2013-2?op=1) [\[2\]](http://www.forbes.com/sites/morganbrennan/2012/10/16/americas-most-expensive-zip-codes-2/2/). [Toasts can cost $4](http://venturebeat.com/2013/08/21/4-toast-why-the-tech-industry-is-ruining-san-francisco/).
...
For medium (few months) to long term leases (>= 1 year), [Craigslist](http://sfbay.craigslist.org/). In this case, the cost is heavily dependent on the location. In the less "trendy" areas, such as Redwood City, Sunnyvale or San Jose or the East Bay, the price should start at $500 (for a room). In Mountain View, Palo Alto or San Francisco you'll be lucky to find anything under $700. And don't forget to add some extra $ for utilities (water, electricity, gas, internet).

With all the constraints for finding a place and the not-so-cheap prices, it is easy to understand why so many people are homeless or now deciding to live in trailers.
...
In the city, [Noisebridge](https://www.noisebridge.net/), located in the Mission, is a hackerspace that's more geared to hardware. A little bit more formal is [PARISOMA](http://www.parisoma.com), in SoMa. Membership for the open space costs $300 with one month notice before leaving. Other (more expensive) alternatives, are for example [WeWork](https://www.wework.com/sf).
...
For getting around in San Francisco, you can get the MUNI, the major public transportation system in the city, covering most of it with its buses and a few metropolitan-like trains. Unfortunately it is not the most reliable system, so it is not uncommon to experience random delays. A ride costs $2.

My preferred transportation system is the bycicle. San Francisco has plenty of [bike routes](http://www.7x7.com/fitness-outdoors/five-bike-routes-every-san-francisco-rider-should-know). Google Maps has an okay bike route option but it doesn't seem to take into much consideration the steepness of the paths. [This calculator](http://amarpai.com/bikemap/) might help you with that.
...
### Communications
US mobile plans are a bit more expensive than I'd like. The big phone carriers are Verizon, AT&T, T-Mobile and Sprint. According to testimonies from friends, AT&T and Verizon are pretty good all around. T-Mobile's reception can be shaky at some places. I have no idea about Sprint.
...
<!--
## <a id="immigration"> </a> Moving to the US
I am not a lawyer, so go get legal information from a trusted source.

types of visa: b1, b2, f1, j1, h1b, green card
-->
